...
import profile from "../assets/profile_v2.jpg"; // Use the newly added, provided image
...
function Hero() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        ref={imgRef}
        className="z-10 w-32 h-32 sm:w-44 sm:h-44 md:w-56 md:h-56 rounded-full shadow-2xl ring-4 ring-accent/45 flex items-center justify-center bg-transparent
                   border-4 border-zinc-200 dark:border-zinc-800 glass-bg"
        style={{
          perspective: 800,
          boxShadow:
      ...
      >
        <motion.img
          ...
          style={{
            ...
            rotateY,
            filter: shadow.to((s) =>
              `drop-shadow(0px ${16 + s * 10}px 44px rgba(63,48,115,0.15))`
            ),
        ...
        <motion.div
          ...
          style={{
            background:
              "radial-gradient(circle at 45% 23%,rgba(255,255,255,0.29) 0%,rgba(240,240,255,0.03) 72%,transparent 98%)",
